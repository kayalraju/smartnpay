                  ...
                  <tbody>
                   @if (count($result['admins']) > 0)
                      @foreach ($result['admins']  as $key=>$admin)
                        ...
                        <td>{{ $admin->email }}</td>
                        <td>{{ $admin->phone }}</td>
                        <td>{{ $admin->states_name }}</td>
                        <td>{{ $admin->districts_name }}</td>
                        <td>{{ $admin->vidhan_sabhas_name }}</td>
                        <td>
                        ...
                        <td>
                          ...
                          @endif
								        ...
								        <td>
                        <a role="menuitem" tabindex="-1" href="editadmin/{{ $admin->id }}">{{ trans('labels.editadmin') }}</a>
                        </td>
                      </tr>
                    @endforeach
                            @else
