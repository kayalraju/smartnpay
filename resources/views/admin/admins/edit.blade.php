                        ...
                        <!-- form start -->
                         <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    {!! Form::text('email',  $result['admins'][0]->email, array('class'=>'form-control  field-validate', 'id'=>'email'))!!}
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <select class="form-control field-validate" id="gender" name="gender">
                                        ...
                                        <option value="male" <?php echo $result['admins'][0]->gender == "male"?"selected":""; ?>>Male</option>
                                        <option value="female" <?php echo $result['admins'][0]->gender == "female"?"selected":""; ?>>Female</option>
                                        <option value="others" <?php echo $result['admins'][0]->gender == "others"?"selected":""; ?>>Others</option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <select class="form-control field-validate" id="entry_state_id" name="states_id">
                                        ...
                                        @if(count($result['states'])>0)
                                        @foreach ($result['states'] as $key=>$states)
                                            <option value="{{ $states->states_id }}" <?php echo $result['admins'][0]->states_id == $states->states_id?"selected":""; ?>>{{ $states->states_name }}</option>
                                        @endforeach
                                        @endif
                                      <select class="form-control field-validate" id="entry_state_id" name="states_id">
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.LanguageDirection') }}</span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <select class="form-control field-validate districts_content" id="entry_district_id" name="districts_id">
                                      @if(count($result['districts'])>0)
                                        @foreach ($result['districts'] as $key=>$districts)
                                            <option value="{{ $districts->districts_id }}" <?php echo $result['admins'][0]->districts_id == $districts->districts_id?"selected":""; ?>>{{ $districts->districts_name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.LanguageDirection') }}</span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    ...
                                    @if(count($result['vidhanSabhas'])>0)
                                    @foreach ($result['vidhanSabhas'] as $key=>$vidhanSabhas)
                                        <option value="{{ $vidhanSabhas->vidhan_sabhas_id }}" <?php echo $result['admins'][0]->vidhan_sabhas_id == $vidhanSabhas->vidhan_sabhas_id?"selected":""; ?>>{{ $vidhanSabhas->vidhan_sabhas_name }}</option>
                                    @endforeach
                                    @endif	
                                    </select>
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.LanguageDirection') }}</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('phone',  $result['admins'][0]->phone, array('class'=>'form-control  field-validate', 'id'=>'phone'))!!}
                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
