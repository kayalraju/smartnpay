...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> MDFA TO MDFA ACCOUNT TRANSFER <small>MDFA TO MDFA ACCOUNT TRANSFER...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
                <li><a href="{{ URL::to('admin/mdf_users/display')}}"><i class="fa fa-money"></i>MDFA TO MDFA ACCOUNT TRANSFER</a></li>
                <li class="active">MDFA TO MDFA ACCOUNT TRANSFER </li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">MDFA TO MDFA ACCOUNT TRANSFER</h3>
                        </div>
                                    ...
                                    <div class="box box-info"><br>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="first_name" class="col-sm-2 col-md-3 control-label">Sender Account Number
                                                </label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('user_account_sender_id',  '', array('class'=>'form-control  field-validate', 'id'=>'user_account_sender_id'))!!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                    Please enter Sender Account Number</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('user_account_receiver_id',  '', array('class'=>'form-control  field-validate', 'id'=>'user_account_sender_id'))!!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                    Please enter Sender Account Number</span>
                                                    <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                                </div>
