                         ...
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/addNewSlide', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input class="form-control field-validate" type="text" name="slider_title" value="">
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                {{-- <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input class="form-control field-validate" type="text" name="slider_content" value="">
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                  ...
                                  <label for="name" class="col-sm-2 col-md-3 control-label" >Slider Content Description</label>
                                  <div class="col-sm-10 col-md-8">
                                    <textarea id="description" name="slider_content_dec" rows="4" cols="50"></textarea>
                                    {{-- <input class="form-control field-validate" type="text" name="slider_content_dec" value=""> --}}
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
