                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">{{ trans('labels.EditDistrict') }}</h3>
                        </div>
                                    ...
                                    <div class="box box-info"><br>
                                      ...
                                      @endif
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/districts/update', 'method'=>'post', 'class' => 'form-horizontal field-validat', 'enctype'=>'multipart/form-data')) !!}
                                            {!! Form::hidden('id',  $district->districts_id , array('class'=>'form-control', 'id'=>'id')) !!}
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.DistrictName') }}</label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('districts_name', $district->districts_name, array('class'=>'form-control field-validat', 'id'=>'districts_name'))!!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    @foreach ($stateData['states'] as $key=>$states)
                                                        <option value="{{ $states->states_id }}" <?php echo $district->states_id == $states->states_id?"selected":""; ?> >{{ $states->states_name }}</option>
                                                    @endforeach
                                                    @endif
                                                    </select>
