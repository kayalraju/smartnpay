...
class Images extends Model
{
    ...
    public function imagedelete($id){
        ...
        foreach ($required_record as $key => $value) {
            $required_image_full_path = $value->path;
    ...
    public function regenerate($image_id, $id, $width, $height)
    {
        ...
        $namethumbnail = Image::make($original_image_path)->resize($width, $height, function ($constraint) {
